...
const MyListView = (props) => {
  const { favotiteList, search, filterData, serachFilter } = props;
          ...
          <>
            {filterData.map((item, index) => (
              <View key={index} style={{ flexDirection: "row" }}>
                ...
                >
                  <View>
                    <Image style={styles.imgNearmeFood} source={item.img} />
                  </View>
                </TouchableOpacity>
                <View>
                  <Text style={[styles.txtGray, { paddingVertical: 3 }]}>
                    📍 {item.address}
                  </Text>
                  <Text style={[styles.txtGray, { paddingVertical: 3 }]}>
                    🕒 {item.time} min · {item.km}km
                  </Text>
              ...
              return (
                item.favorite == true && (
                  <View key={index} style={{ flexDirection: "row" }}>
                    ...
                    <View>
                      <Text style={[styles.txtweight, { paddingVertical: 10 }]}>
                        {item.name}
                      </Text>
                      <Text
                        style={[
                          styles.txtweight,
                          { paddingVertical: 5, color: R.colors.colorMain },
                        ]}
                      >
