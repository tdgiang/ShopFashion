...
const MyCartView = (props) => {
  ...
  const { product, addCart, decreaseItem, deleteItem, total, onPressCheckOut } =
    props;
    ...
    <View style={{ flex: 1, backgroundColor: R.colors.white }}>
        ...
        renderItem={({ item, index }) => {
          return (
            ...
            >
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text style={[styles.txtweight, { paddingVertical: 5 }]}>
                    {item.name}
                  </Text>
                  <View style={[styles.row, { paddingVertical: 5 }]}>
                    <View style={[styles.row]}>
                      <Text style={styles.txtGray}>Size {item.size}</Text>
                    </View>
                  </View>
      ...
      <View style={{ flex: 0.6, paddingTop: 50 }}>
        <View style={styles.rowbtn}>
          <Text style={styles.txt}>Mã giảm giá</Text>
          <TouchableOpacity
            style={styles.btn}
            // onPress={() => navigation.navigate(CHANGE_PASS_SCREEN)}
          >
            <Text style={[styles.txtGray, { marginLeft: 140 }]}>
              Chọn mã giảm giá
            </Text>
        ...
        <View style={[styles.rowbtn, { paddingVertical: 20 }]}>
          ...
          <Text style={styles.txtTotal}>{total} đ</Text>
        </View>
        <Button
          ...
          title={"Check out"}
          backgroundColor={
            product?.cart.length > 0 ? R.colors.colorMain : R.colors.gray5
          }
          containerStyle={{
            height: 50,
            marginHorizontal: 15,
